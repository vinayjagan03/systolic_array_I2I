...
# Create the primary clock (1 ns period)
...
set_input_delay -max 0.02 -clock [get_clocks clk] [remove_from_collection [all_inputs] [get_ports clk]]
set_input_delay -min 0.0 -clock [get_clocks clk] [remove_from_collection [all_inputs] [get_ports clk]]

set_output_delay -max 0.02 -clock [get_clocks clk] [all_outputs]

#set_driving_cell -lib_cell BUF_X2 -max [ all_inputs ]
#set_driving_cell -lib_cell BUF_X16 -min [ all_inputs ]
